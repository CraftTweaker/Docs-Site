...
export default function Deprecated({ props }: { props: PropsWithChildren<unknown> }): ReactElement {
    const hasChildren = !!props.children;
    return <div className = {`bg-red-500 border-2 border-red-500 bg-opacity-25 mb-4`}>
